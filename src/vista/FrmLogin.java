...
public class FrmLogin extends javax.swing.JFrame {
    ...
    public FrmLogin() {
        ...
        this.setTitle("Azules Forrajeria - Login");
    ...
    private void initComponents() {
        ...
        jLabel1.setText("® Programador Gregorio");
        ...
        jButton_IniciarSesion.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 0, 350, 600));
    ...
    private void Login() {
        if (!txt_usuario.getText().isEmpty() && !txt_password.getText().isEmpty()) {
            ...
            if (controlUsuario.loginUser(usuario)) {
                //JOptionPane.showMessageDialog(null, "Bienvenidos al sistema de ventas!", "Bienvenidos!", JOptionPane.INFORMATION_MESSAGE);
